...
sbatch -n 1 --cpus-per-task 4 -p cca -o logs/1yr_32.out -e logs/1yr_32.err fit.py --sampfile parameters_1yr.h5 --samp 32 --selfile selected.h5 --chainfile population_1yr_0032.h5 --tracefile traceplot_1yr_0032.pdf
sbatch -n 1 --cpus-per-task 4 -p cca -o logs/1yr_64.out -e logs/1yr_64.err fit.py --sampfile parameters_1yr.h5 --samp 64 --selfile selected.h5 --chainfile population_1yr_0064.h5 --tracefile traceplot_1yr_0064.pdf
