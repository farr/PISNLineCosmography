...
# Small runs
sbatch -n 1 --cpus-per-task 4 -p cca -o logs/small.out -e logs/small.err fit.py --sampfile parameters_small.h5 --samp 64 --selfile selected.h5 --nsel 2048 --chainfile population_small.h5 --tracefile traceplot_small.pdf
