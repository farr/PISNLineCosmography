...
# Five year runs
sbatch -n 1 --cpus-per-task 4 -p cca -o logs/5yr.out -e logs/5yr.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr.h5 --tracefile traceplot_5yr.pdf
sbatch -n 1 --cpus-per-task 4 -p cca -o logs/5yr2.out -e logs/5yr2.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr2.h5 --tracefile traceplot_5yr2.pdf
