...
sbatch -n 1 --cpus-per-task 4 -t 20-00:00:00 -o logs/5yr_free.out -e logs/5yr_free.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr_free.h5 --tracefile traceplot_5yr_free.pdf --prior free
sbatch -n 1 --cpus-per-task 4 -t 20-00:00:00 -o logs/5yr_Planck_Om_w.out -e logs/5yr_Planck_Om_w.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr_Planck_Om_w.h5 --tracefile traceplot_5yr_Planck_Om_w.pdf --prior Planck-Om-w
sbatch -n 1 --cpus-per-task 4 -t 20-00:00:00 -o logs/5yr_H0.out -e logs/5yr_H0.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr_H0.h5 --tracefile traceplot_5yr_H0.pdf --prior H0
sbatch -n 1 --cpus-per-task 4 -t 20-00:00:00 -o logs/5yr_H0_Planck_Om.out -e logs/5yr_H0_Planck_Om.err fit.py --sampfile parameters.h5 --samp 64 --selfile selected.h5 --nsel 262144 --chainfile population_5yr_H0_Planck_Om.h5 --tracefile traceplot_5yr_H0_Planck_Om.pdf --prior H0-Planck-Om
