#!/bin/bash
#SBATCH -n 1 --ntasks 6 --cpus-per-task 4 -p gen -t 14-00:00:00 -o logs/run.out -e logs/run.err
...
./fit.py --cosmo-prior --sampfile observations.h5 --subset 1yr --selfile selected.h5 --nsel $NSEL --chainfile population_1yr_cosmo.h5 --tracefile traceplot_1yr_cosmo.pdf > logs/1yr_cosmo.out 2>&1 &
