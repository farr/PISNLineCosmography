#!/bin/bash
#SBATCH -n 1 --ntasks 1 --cpus-per-task 4 -p gen -t 21-00:00:00 -o logs/run.out -e logs/run.err
...
NSEL=131072
./fit.py --iter 4000 --thin 2 --sampfile observations.h5 --selfile selected.h5 --nsel $NSEL --chainfile population_5yr.h5 --tracefile traceplot_5yr.pdf > logs/5yr.out 2>&1 &
