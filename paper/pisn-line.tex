...
\sim 0.5$.  If we assume that $\sim 1/4$ these detections are informative about
...
rate, $H(z)$, for $z \simeq \zpivot{}$) at the $50 \% / \sqrt{1000/4} \simeq 3
\%$ level after one year, and the $1.4 \%$ level after five years of \ac{BBH}
merger observations at design sensitivity.
